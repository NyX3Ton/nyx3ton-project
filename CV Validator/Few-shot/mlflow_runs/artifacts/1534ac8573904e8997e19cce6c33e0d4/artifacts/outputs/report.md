...
| ✅ splnene | Curiosity about AI and excitement to apply it to solve meaningful problems | 85 | nice / w=1.0 | Kandidat má silné skúsenosti s AI/ML, patenty v tejto oblasti a aktívne využíva technológie na riešenie problémov. |
| ❌ nesplnene | We're Swiss Re's biggest data science team... | 0 | unknown / w=1.5 | Kandidat pracuje v oblasti data science a AI, ale nie je uvodneny v zamestnaní v spoločnosti Swiss Re ani v inzeráte. |
...
### ✅ R13: Curiosity about AI and excitement to apply it to solve meaningful problems
**Pouzite odkazy:**
- AI-driven Infrastructure Anomaly Detection: Developed a Python + SQL + Grafana solution predicting call volume anomalies in real-time, which reduced false positives
- Patent Activity: Filed multiple patents in AI/ML applied to IT infrastructure and automation analytics.
- ML-based predictive models (XGBoost) to identify anomalies in infrastructure telemetry

### ❌ R14: We're Swiss Re's biggest data science team...
**Riziko/neistota:** Kandidat má skusenosti s data science, ale nevyhovuje na konkrétnu požadovanú organizáciu.